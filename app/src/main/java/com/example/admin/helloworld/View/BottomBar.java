...
public class BottomBar extends View {
    ...
    public BottomBar setToolbar(Toolbar toolbar) {
        this.toolbar = toolbar;
        return this;
    }

    public BottomBar setActivity(Activity activity) {
        this.activity = activity;
        return this;
    }

    public BottomBar setDrawerLayout(DrawerLayout drawerLayout) {
    ...
    public void change(){
            System.out.println(target);
            if (target == 1)
                StatusBarUtil.setColorForDrawerLayout(activity, drawerLayout, -94975, 0);
            else
                if(target != 0)
                    StatusBarUtil.setColorForDrawerLayout(activity, drawerLayout, 0, 0);
                else
                     StatusBarUtil.setColorForDrawerLayout(activity, drawerLayout, -14974254, 0);
    }
